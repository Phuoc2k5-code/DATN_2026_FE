    ...
    return (
        <div className="w-full min-h-screen bg-[#FFFDF9] font-sans text-slate-800 antialiased flex">
            ...
            <aside className="w-64 bg-white border-r border-orange-100 flex flex-col justify-between shrink-0 sticky top-0 h-screen">
                ...
                <div className="p-4 border-t border-slate-100 bg-slate-50/50 m-3 rounded-xl flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-amber-100 flex items-center justify-center font-bold text-amber-700 text-sm">
                        HR
                    </div>
                    <div className="overflow-hidden">
                        <h4 className="text-xs font-bold text-slate-800 truncate">Thông tin tài khoan</h4>
                        <p className="text-[10px] text-slate-400 truncate">recruiter@vng.com.vn</p>
                    </div>
                </div>
            </aside>
