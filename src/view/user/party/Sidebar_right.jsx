...
export default function SidebarRight() {
    return (
        <div className="w-14 bg-white border border-slate-200 shadow-sm rounded-2xl flex flex-col items-center py-3 gap-3 sticky top-24 h-fit shrink-0">
            ...
            <div className="flex flex-col items-center group cursor-pointer w-full text-center px-1">
                <div className="p-1 rounded-lg text-slate-400 transition-all group-hover:bg-orange-50 group-hover:text-orange-500"><Calendar size={12} /></div>
                <span className="text-[8px] font-bold text-slate-400 mt-0.5 transition-colors group-hover:text-orange-600">Lịch hẹn</span>
            </div>

            <div className="flex flex-col items-center group cursor-pointer w-full text-center px-1">
                <div className="p-1 rounded-lg text-slate-400 transition-all group-hover:bg-emerald-50 group-hover:text-emerald-500"><MessageSquare size={12} /></div>
                <span className="text-[8px] font-bold text-slate-400 mt-0.5 transition-colors group-hover:text-emerald-600">Tin nhắn</span>
            </div>

            <div className="flex flex-col items-center group cursor-pointer w-full text-center px-1">
                <div className="p-1 rounded-lg text-slate-400 transition-all group-hover:bg-rose-50 group-hover:text-rose-500"><Bookmark size={12} /></div>
            ...
            <div className="flex flex-col items-center group cursor-pointer w-full text-center px-1">
                <div className="p-1 rounded-lg text-slate-400 transition-all group-hover:bg-slate-100 group-hover:text-slate-700"><Settings size={12} /></div>
